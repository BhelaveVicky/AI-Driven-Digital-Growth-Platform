    ...
    <div className="min-h-screen bg-slate-950 text-white">
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-6 text-center divide-y md:divide-y-0 md:divide-x divide-slate-800">
            {stats.map((stat, idx) => (
              <div key={idx} className={`${idx > 0 ? 'pt-4 md:pt-0' : ''}`}>
                <p className="text-2xl sm:text-3xl font-extrabold text-transparent bg-clip-text bg-gradient-to-r from-indigo-400 to-cyan-300">
                  {stat.value}
                </p>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 relative">
            ...
            <div className="bg-slate-900 border border-slate-800 rounded-2xl p-6 text-center space-y-4 relative">
              <div className="w-12 h-12 rounded-xl bg-indigo-600/20 text-indigo-400 font-extrabold text-xl flex items-center justify-center mx-auto border border-indigo-500/30">
                01
              </div>
              <h3 className="text-lg font-bold text-white">Fill Free Analysis Form</h3>
            ...
            <div className="bg-slate-900 border border-slate-800 rounded-2xl p-6 text-center space-y-4 relative">
              <div className="w-12 h-12 rounded-xl bg-cyan-600/20 text-cyan-400 font-extrabold text-xl flex items-center justify-center mx-auto border border-cyan-500/30">
                02
              </div>
              <h3 className="text-lg font-bold text-white">Get Custom AI Report</h3>
              <p className="text-slate-400 text-sm leading-relaxed">
            ...
            <div className="bg-slate-900 border border-slate-800 rounded-2xl p-6 text-center space-y-4 relative">
              <div className="w-12 h-12 rounded-xl bg-purple-600/20 text-purple-400 font-extrabold text-xl flex items-center justify-center mx-auto border border-purple-500/30">
                03
              </div>
              <h3 className="text-lg font-bold text-white">Scale Sales & Traffic</h3>
              <p className="text-slate-400 text-sm leading-relaxed">
      ...
      <section className="py-20 relative">
        <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="relative rounded-3xl p-8 sm:p-12 overflow-hidden bg-gradient-to-r from-indigo-900 via-slate-900 to-purple-950 border border-indigo-500/30 shadow-2xl text-center space-y-6">
            
            <div className="inline-flex items-center gap-2 px-4 py-1.5 rounded-full bg-cyan-500/20 border border-cyan-400/30 text-cyan-300 text-xs font-semibold">
            ...
            <div className="pt-2 flex flex-col sm:flex-row items-center justify-center gap-4">
              <button
                ...
                className="w-full sm:w-auto inline-flex items-center justify-center gap-2 px-8 py-4 rounded-xl font-bold text-white bg-gradient-to-r from-indigo-500 to-cyan-500 hover:from-indigo-600 hover:to-cyan-600 shadow-xl shadow-indigo-500/30 transition-all text-base hover:scale-105"
              >
